// Variables being used within project
...
// Helper Function to Set Attirbutes on DOM Elements
...
function displayPhotos() {
	...
	photosArray.forEach((photo) => {
		...
		// Event Listener, check whne each is finished loaded
